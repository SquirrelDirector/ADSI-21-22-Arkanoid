...
public class IU_Niveles extends JFrame implements Observer {
	...
	private void seleccionar(int lvl){
		...
		switch (nivel) {
		case 1:
			elLabel.setText("<HTML>Version f�cil del juego, ideal <br>para principiantes y gente adapt�ndose al juego. <br><br> - 2 l�neas de bloques <br> - anchura de la barra aumentada <br> - velocidad est�ndar</HTML>");
			break;
		case 2:
			elLabel.setText("<HTML>Dificultad original del juego, <br>para gente con algo m�s de experiencia. <br><br> - 4 l�neas de bloques <br> - anchura de barra y vel�cidad est�ndar");
			break;
		case 3:
			elLabel.setText("<HTML>Versi�n dif�cil del juego, <br>para gente buscando una experiencia desafiante. <br><br> - 6 l�neas de bloques <br> - anchura de barra est�ndar <br> - vel�cidad aumentada</HTML>");
			break;
		case 4:
			...
			break;
		case 5:
			elLabel.setText("<HTML>Crea tu propio nivel y prueba <br>tantas combinaciones de dificultad como quieras. <br><br>Accede al bot�n de personalizar para cambiarlo <br>(La puntuaci�n no se guardar� en los r�nkings)</HTML>");
			break;
		}
		repaint();
		revalidate();

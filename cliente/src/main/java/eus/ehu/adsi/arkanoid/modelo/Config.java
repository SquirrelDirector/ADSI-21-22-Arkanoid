...
public abstract class Config {
	...
	public static java.awt.Color BACKGROUND_COLOR = Color.black;
	public static java.awt.Color BALL_COLOR = Color.orange;
	public static java.awt.Color PADDLE_COLOR = Color.red;
	public static java.awt.Color BRICK_COLOR = Color.blue;

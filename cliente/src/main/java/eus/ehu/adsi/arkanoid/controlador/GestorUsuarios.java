...
public class GestorUsuarios {
	...
	public JSONObject importarUsuario(String mail, String pass) {
		...
		if (!pass.equals(usrPass)) //el usuario no tiene tal contrase�a
			return null;
	...
	public void crearUsuario(String usr, String mail, String pass) {
		String preg="INSERT INTO Usuario (Email, NombreUsuario, Contrase�a) VALUES ('"+mail+"', '"+usr+"', '"+pass+"');";
	...
	public void cambiarContrasena(String mail, String pass) {
		String preg="UPDATE Usuario SET Contrase�a="+pass+" WHERE Email='"+mail+"';";
		GestorDB.getGestorDB().execSQL(preg);
	}
